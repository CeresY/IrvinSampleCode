...
public class CodeCacheTest {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        CodeCache.put(key, 123);
        System.out.println("key:" + key + ", value:" + CodeCache.get(key));
        System.out.println("key:" + key + ", value:" + CodeCache.remove(key));
        System.out.println("key:" + key + ", value:" + CodeCache.get(key));

        //设置过期时间
        System.out.println("\n***********设置过期时间**********");
        CodeCache.put(key, "123456", 1000);
        System.out.println("key:" + key + ", value:" + CodeCache.get(key));
        Thread.sleep(2000);
        System.out.println("key:" + key + ", value:" + CodeCache.get(key));
...
//                });
        ...
        System.out.println("当前缓存容量：" + CodeCache.size());
    }
}
